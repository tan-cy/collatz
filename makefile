...
FILES :=                              \
    ...
    TestCollatz.out                   \
    TestCollatz.py					  \
	cs330e-collatz-tests/tancy-RunCollatz.in   \
	cs330e-collatz-tests/tancy-RunCollatz.out  \
	cs330e-collatz-tests/tancy-TestCollatz.out \
	cs330e-collatz-tests/tancy-TestCollatz.py  \
	cs330e-collatz-tests/tancy-TestCollatz.py  \
